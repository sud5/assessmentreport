...
/**
 * Strings for component 'report_assessmentreports', language 'en'
 *
...
$string['pluginname'] = 'Transcripts for Teacher (pdf)';
$string['printmode'] = 'Printable';
$string['privacy:metadata'] = 'The assessmentreports report only shows data stored in other locations.';
$string['assessmentreports:view'] = 'View assessmentreports course report';
...
$string['settings:displayname:default'] = 'assessmentreports';
